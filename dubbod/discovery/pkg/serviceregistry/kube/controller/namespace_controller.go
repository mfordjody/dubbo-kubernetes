...
import (
	"github.com/apache/dubbo-kubernetes/dubbod/security/pkg/k8s"
...
const (
	...
	CRLNamespaceConfigMap = "dubbo-ca-crl"
)
...
var (
	...
	configMapLabel = map[string]string{"dubbo.apache.org/config": "true"}
)
